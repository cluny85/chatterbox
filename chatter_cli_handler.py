...
import json
import traceback
from Chatter import process_text_for_tts, default_settings, whisper_model_map
...
def main():
    ...
    try:
        ...
        exit_with_error_json(f"An error occurred during generation: {e}", details=tb_str)
